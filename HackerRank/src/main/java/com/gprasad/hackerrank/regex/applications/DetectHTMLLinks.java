...
Detect HTML links  (Hackerrank Java Solution)
...
If there are N links in the document, display each of them in a new line. The link and the text name must be separated by a "," (comma) with no spaces between them.
